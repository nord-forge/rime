...
# ENV-35 — Schema-driven properties panel
...
## Out of scope
- The block schemas themselves (ENV-33/61) — the panel consumes them.
- Inline rich-text editing (ENV-27/52) — `richtext` fields are edited on canvas.
- Selection mechanics on the canvas (ENV-19) — panel consumes a selected id.
- Token picker (ENV-40).
