...
# ENV-03 — CI pipeline + bundle-size gate
...
4. **No Playwright here.** Browser E2E is wired in ENV-04; this pipeline must not
   require browser binaries (keeps CI fast). If ENV-04 lands first, leave a TODO
...
## Out of scope
- Playwright / browser E2E in CI (ENV-04).
- npm publish / release automation (ENV-104).
