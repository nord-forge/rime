...
**Progress: 29 / 52 tickets done.** Milestones 0–4 complete; Milestone 5 (inline
rich text) in progress — ENV-27/28/30 done (headless Lexical in-iframe, one-instance
lifecycle, lossless RichTextJSON↔Lexical round-trip incl. headings/lists/links;
core 63.57 kB gzip vs ~100 kB budget).
