...
export { sectionBlock, columnBlock, textBlock, imageBlock, buttonBlock, dividerBlock, spacerBlock };

// Register the seven core blocks. Idempotent — a double import (or a re-call after
