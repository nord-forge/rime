...
depends_on: [ENV-01]
blocks: [ENV-06, ENV-08, ENV-09, ENV-10, ENV-16, ENV-33]
package: doc-model
prd: [§6.1]
estimate: M
---

# ENV-05 — Document model schema + validation
...
## Out of scope
- Immutable update / patch diffs (ENV-06). Undo (ENV-07). Serialize/load (ENV-09).
- Rendering of any kind. Block REGISTRATION interface (ENV-33) — this is just the
  built-in node TYPES.
